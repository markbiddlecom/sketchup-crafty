...
module Crafty
  module Attributes
    ...
    def self.get_attribute(entity, attribute_name, default_value = nil)
      return entity.get_attribute CRAFTY_DICTIONARY_NAME, attribute_name, default_value
    end
    ...
    def self.set_attribute(entity, attribute_name, value)
      return entity.set_attribute entity, attribute_name, value
    end
    ...
    def self.has_attribute(entity, attribute_name)
      dict = entity.attribute_dictionary CRAFTY_DICTIONARY_NAME
      return dict.nil? ? false : (dict.keys.include? attribute_name)
    end
    ...
    def self.entities_with_attribute(entities, attribute_name)
      return entities.find_all { |e| self.has_attribute e, attribute_name }
    end
    ...
    def self.tag_primary_face(face)
      return self.set_attribute face, ATTRIBUTE_PRIMARY_FACE, ATTRIBUTE_PRIMARY_FACE_VALUE
    end
    ...
    def self.find_primary_faces(entities)
      return self.entities_with_attribute(entities, ATTRIBUTE_PRIMARY_FACE).grep(Sketchup::Face)
    end
